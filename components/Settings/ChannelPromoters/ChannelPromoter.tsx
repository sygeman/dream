...
import { Button, Input, SWRow, Icon, Avatar } from '../../../ui';
		...
		{({ channel }) => (
			<ChannelPromoterBox>
				<ChannelPromoterHeader>
					<ChannelHeaderInfo>
						<ChannelAvatar>
							<Avatar avatar={channel.avatar} dot={channel.cost > 0 && channel.live} dotColor="#d54141" />
						</ChannelAvatar>
						<ChannelName target="_blank" href={`https://www.twitch.tv/${channel.name}`}>
							{channel.name}
						</ChannelName>
