  ...
  return (
    <Portal>
      <div className="flex fixed top-0 left-0 w-full h-full overflow-hidden">
        <div
          className="flex fixed top-0 left-0 w-full h-full bg-gray-900 opacity-90"
          onClick={closeModal}
        ></div>
        <div className="m-auto z-30 bg-gray-800 rounded overflow-hidden">
          {!minimal && (
            <div className="bg-indigo-600 px-4 py-2 flex items-center">
