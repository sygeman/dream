 ...
 * });
 */
export function useTwitchStreamQuery(
  baseOptions: Apollo.QueryHookOptions<
    TwitchStreamQuery,
    TwitchStreamQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<TwitchStreamQuery, TwitchStreamQueryVariables>(
    TwitchStreamDocument,
    options
  );
}
export function useTwitchStreamLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<TwitchStreamQuery, TwitchStreamQueryVariables>(
    TwitchStreamDocument,
    options
  );
}
export type TwitchStreamQueryHookResult = ReturnType<
  typeof useTwitchStreamQuery
>;
export type TwitchStreamLazyQueryHookResult = ReturnType<
  typeof useTwitchStreamLazyQuery
>;
export type TwitchStreamQueryResult = Apollo.QueryResult<
  TwitchStreamQuery,
  TwitchStreamQueryVariables
>;
export const UpdateTwitchStreamDocument = gql`
  ...
  ${TwitchStreamFieldsFragmentDoc}
`;
export type UpdateTwitchStreamMutationFn = Apollo.MutationFunction<
  UpdateTwitchStreamMutation,
  UpdateTwitchStreamMutationVariables
>;
 ...
 * });
 */
export function useUpdateTwitchStreamMutation(
  ...
  return Apollo.useMutation<
    UpdateTwitchStreamMutation,
    UpdateTwitchStreamMutationVariables
  >(UpdateTwitchStreamDocument, options);
}
export type UpdateTwitchStreamMutationHookResult = ReturnType<
  typeof useUpdateTwitchStreamMutation
>;
export type UpdateTwitchStreamMutationResult =
  Apollo.MutationResult<UpdateTwitchStreamMutation>;
export type UpdateTwitchStreamMutationOptions = Apollo.BaseMutationOptions<
  UpdateTwitchStreamMutation,
  UpdateTwitchStreamMutationVariables
>;
