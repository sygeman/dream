...
export type CommunitySettingsQuery = {
  __typename?: 'Query';
  communitySettings: {
...
export type UpdateCommunitySettingsMutation = {
  __typename?: 'Mutation';
...
export type CommunitySettingsFieldsFragment = {
  __typename?: 'CommunitySettings';
  id: string;
  name?: string | null;
  title: string;
 ...
 * });
 */
export function useCommunitySettingsQuery(
  baseOptions: Apollo.QueryHookOptions<
    CommunitySettingsQuery,
    CommunitySettingsQueryVariables
  >
) {
  ...
  return Apollo.useQuery<
    CommunitySettingsQuery,
    CommunitySettingsQueryVariables
  >(CommunitySettingsDocument, options);
}
export function useCommunitySettingsLazyQuery(
...
export type CommunitySettingsQueryHookResult = ReturnType<
  typeof useCommunitySettingsQuery
>;
export type CommunitySettingsLazyQueryHookResult = ReturnType<
  typeof useCommunitySettingsLazyQuery
>;
export type CommunitySettingsQueryResult = Apollo.QueryResult<
  CommunitySettingsQuery,
  CommunitySettingsQueryVariables
>;
export const UpdateCommunitySettingsDocument = gql`
  ...
  ${CommunitySettingsFieldsFragmentDoc}
`;
export type UpdateCommunitySettingsMutationFn = Apollo.MutationFunction<
  UpdateCommunitySettingsMutation,
 ...
 * });
 */
export function useUpdateCommunitySettingsMutation(
  ...
  return Apollo.useMutation<
    UpdateCommunitySettingsMutation,
    UpdateCommunitySettingsMutationVariables
  >(UpdateCommunitySettingsDocument, options);
}
export type UpdateCommunitySettingsMutationHookResult = ReturnType<
  typeof useUpdateCommunitySettingsMutation
>;
export type UpdateCommunitySettingsMutationResult =
  Apollo.MutationResult<UpdateCommunitySettingsMutation>;
export type UpdateCommunitySettingsMutationOptions = Apollo.BaseMutationOptions<
  UpdateCommunitySettingsMutation,
  UpdateCommunitySettingsMutationVariables
>;
