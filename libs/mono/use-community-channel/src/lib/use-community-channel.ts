import {
  useChannelForCcQuery,
  useCommunityForCcQuery,
} from './community-channel.api';
...
export const useCommunityChannel = () => {
  ...
  const communityQuery = useCommunityForCcQuery({
  ...
  const channelQuery = useChannelForCcQuery({
