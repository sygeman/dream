...
export function useUpdateConnectionStatusMutation(
  ...
  return Apollo.useMutation<
    UpdateConnectionStatusMutation,
    UpdateConnectionStatusMutationVariables
  >(UpdateConnectionStatusDocument, options);
}
export type UpdateConnectionStatusMutationHookResult = ReturnType<
  typeof useUpdateConnectionStatusMutation
>;
export type UpdateConnectionStatusMutationResult =
  Apollo.MutationResult<UpdateConnectionStatusMutation>;
...
`;
export type SetUserLocaleMutationFn = Apollo.MutationFunction<
  SetUserLocaleMutation,
  SetUserLocaleMutationVariables
>;
 ...
 * });
 */
export function useSetUserLocaleMutation(
  baseOptions?: Apollo.MutationHookOptions<
    SetUserLocaleMutation,
    SetUserLocaleMutationVariables
  >
  ...
  return Apollo.useMutation<
    SetUserLocaleMutation,
    SetUserLocaleMutationVariables
  >(SetUserLocaleDocument, options);
}
export type SetUserLocaleMutationHookResult = ReturnType<
  typeof useSetUserLocaleMutation
>;
export type SetUserLocaleMutationResult =
  Apollo.MutationResult<SetUserLocaleMutation>;
export type SetUserLocaleMutationOptions = Apollo.BaseMutationOptions<
  SetUserLocaleMutation,
  SetUserLocaleMutationVariables
>;
